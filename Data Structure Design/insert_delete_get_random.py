...
class RandomizedSet:
    ...
    def insert(self, val: int) -> bool:
        ...
        self.position[val] = len(self.array)
    ...
    def remove(self, val: int) -> bool:
        ...
        self.position[last_element] = idx
        self.array[idx], self.array[-1] = last_element, val
...
# O(1) - Time complexity - for: insert, remove, get_random
