...
Let pref[r][c] represent the sum of the rectangle from the top-left corner to (r-1, c-1) in the original matrix.

Using a prefix matrix with one extra row and column makes boundary handling much cleaner.
